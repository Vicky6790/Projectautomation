...
const MONOGRAM_PATH =
  "M 220 200 L 520 200 A 180 180 0 0 1 700 380 A 180 180 0 0 1 520 560 L 360 560 L 360 820 L 220 820 Z";
...
export function ProjectPulseLogo({
  ...
  return (
    ...
    >
      ...
      <rect fill={`url(#${bgGrad})`} height="1024" rx="200" width="1024" />
      <g transform="translate(0, 40)">
        ...
        {reducedMotion ? null : (
          <circle fill="#ffffff" filter={`url(#${glow})`} r="8">
        ...
        {markOnly ? null : (
          <g textAnchor="middle" transform="translate(512, 730)">
            <text
              fill="#22d3ee"
              filter={`url(#${glow})`}
              fontFamily="system-ui, -apple-system, 'Hanken Grotesk', sans-serif"
              fontSize="76"
              fontWeight="800"
              opacity="0.3"
              x="0"
